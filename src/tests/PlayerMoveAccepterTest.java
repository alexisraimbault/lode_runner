...
import contract.algorithms.PlayerMoveAccepterContract;
import model.algorithms.PlayerMoveAccepter;
...
public class PlayerMoveAccepterTest {
	private PlayerMoveAccepterContract commandAccepter;
	IGameState state1;
	IGameState state2;
	IGameState state3;
	IGameState state4;
	...
	public void beforeTests() {
		commandAccepter = new PlayerMoveAccepterContract(new PlayerMoveAccepter());
		...
		EditableEnvironment env3 = new EditableEnvironment(new DynamicScreen());//On a ladder
		...
		env3.setCellNature(8, 2, Nature.LADDER);
		env3.setCellNature(8, 3, Nature.LADDER);
		...
		env4.getCellContent(8, 1).add(EntityType.PLAYER);
		env4.setCellNature(7, 1, Nature.PLATFORM);
		env4.setCellNature(9, 1, Nature.PLATFORM);
		env4.setCellNature(8, 2, Nature.PLATFORM);
		...
		env5.getCellContent(5, 2).add(EntityType.PLAYER);
