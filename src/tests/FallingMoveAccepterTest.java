...
public class FallingMoveAccepterTest {
	private FallingMoveAccepterContract<IPlayer> commandAccepter;
	IGameState state1;
	IGameState state2;
	IGameState state3;
	IGameState state4;
	...
	public void beforeTests() {
		commandAccepter = new FallingMoveAccepterContract(new FallingMoveAccepter<IPlayer>(new PlentyAndCharacterTester()));
